...
<template>
  <section id="hero" class="relative">
    <div class="background w-full h-[100lvh]">
      <img src="../assets/images/hero_image.jpg" class="h-screen w-full object-cover fixed top-0 left-0 z-[-1]" alt="background">
      ...
      <img src="../assets/images/pencil.svg" class="icon-left absolute -rotate-[110deg] bottom-[50px] left-[-100px] w-[250px] md:w-[350px] z-[4]" data-factor="0.2" alt="pencil">
    </div>
